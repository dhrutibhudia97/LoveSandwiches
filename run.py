...
def get_sales_data():
    ...
    Run a while loop to get valid string of data from the user.
    must be 6 values seperated by a commas. Loop 
...
def update_worksheet(data, worksheet):
    """
    Recieves list of integers to be inserted into the worksheet.
...
def calculate_surplus_data(sales_row):
    ...
    surplus = stock - sales. negative number is extra had to be made.
    positive number is the unsold stock.
    """
...
def get_last_5_entries_sales():
    ...
    collects last 5 entries for each sandwich
